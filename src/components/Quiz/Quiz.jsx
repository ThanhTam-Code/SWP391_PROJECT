    ...
    const fetchQuizData = async () => {
      try {
        ...
        const response = await axios.get(
          "https://b865-2405-4802-811e-11a0-875-581e-b53-2910.ngrok-free.app/api/quiz/questions-with-answers",
          {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://b865-2405-4802-811e-11a0-875-581e-b53-2910.ngrok-free.app/api/quiz/submit",
        submissionData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
