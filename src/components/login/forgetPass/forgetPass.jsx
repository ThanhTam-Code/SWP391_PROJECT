...
export default function ForgetPassword() {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://b865-2405-4802-811e-11a0-875-581e-b53-2910.ngrok-free.app/forgotPassword/verifyMail/${email}`,
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://b865-2405-4802-811e-11a0-875-581e-b53-2910.ngrok-free.app/forgotPassword/verifyOtp/${otp}/${email}`,
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://b865-2405-4802-811e-11a0-875-581e-b53-2910.ngrok-free.app/forgotPassword/changePassword/${email}`,
