    ...
    const fetchData = async () => {
      try {
        const [schedulesResponse, servicesResponse] = await Promise.all([
          axios.get(
            `https://b865-2405-4802-811e-11a0-875-581e-b53-2910.ngrok-free.app/api/schedules/busy`,
            {
  ...
  const handleCreateBooking = async () => {
    ...
    try {
      const response = await axios.post(
        `https://b865-2405-4802-811e-11a0-875-581e-b53-2910.ngrok-free.app/api/bookings/guest`,
        bookingRequest,
        { headers: { "ngrok-skip-browser-warning": "true" } }
      );
